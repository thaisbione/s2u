<?php
	...
	if ($linhaAfetada == 0) {
		$inserir = mysql_query("INSERT INTO clientes (nomeServico, descricao, imagem) VALUES ('$_POST[nomeServico]','$_POST[descricao]','$_POST[imagem]')") or die ("Erro ao inserir".mysql_error());
