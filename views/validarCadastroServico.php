<?php
	...
	if ($linhaAfetada == 0) {
		$inserir = mysql_query("INSERT INTO clientes (id,nome, descricao, imagem) VALUES ('$_POST[nomeServico]','$_POST[userId]','$_POST[descricao]','$_POST[imagem]')") or die ("Erro ao inserir".mysql_error());
